...
export default function TransferReceiveRecord() {
  ...
  const [transferEntries, setTransferEntries] = useState([
    {
      ...
      particulars: 'Received Office Supplies Transfer - Stationery Items',
    ...
    },
    {
      ...
      particulars: 'Received IT Equipment Transfer - Laptops & Accessories',
    ...
    },
    {
      ...
      fromBranch: 'Main Branch',
      particulars: 'Received Raw Materials Transfer - Steel Sheets',
    ...
    },
    {
      ...
      particulars: 'Received Document Transfer - Administrative Files',
      category: 'Documents',
    ...
    },
    {
      ...
      particulars: 'Received Safety Equipment Transfer - Helmets & Gloves',
    ...
    },
    {
      ...
      toBranch: 'Sylhet Branch',
      fromBranch: 'Main Branch',
      particulars: 'Today\'s Received Emergency Supply Transfer - Medical Equipment',
      ...
      status: 'Received',
      type: 'without item',
      receivedBy: 'Medical Officer',
      receivedDate: getTodayFormatted().split('/').reverse().join('-')
    },
    {
      id: 7,
      date: getTodayFormatted().split('/').reverse().join('-'),
      ...
      particulars: 'Today\'s Received Test Items Transfer',
  ...
  const handleGetReport = () => {
    try {
      ...
      setShowTable(true)
      setCurrentPage(1)
      console.log('Generating transfer receive record report for:', formData)
  ...
  const handlePrint = () => {
    const printContent = `
      <html>
        <head>
          <title>Transfer Receive Record Report</title>
          <style>
        ...
        <body>
          <h1>Transfer Receive Record Report</h1>
  ...
  const handleExport = () => {
    const csvContent = [
      ['Date', 'Voucher No', 'From Branch', 'To Branch', 'Particulars', 'Category', 'User', 'Amount', 'Transport Cost', 'Total', 'Received By', 'Status'],
      ...filteredEntries.map(entry => [
        entry.date,
        entry.voucherNo,
        entry.fromBranch,
    ...
    a.href = url
    a.download = 'transfer_receive_record.csv'
  ...
  const handleDeleteEntry = (id) => {
    if (window.confirm('Are you sure you want to delete this received transfer record?')) {
  ...
  // Acknowledge receipt
  const handleAcknowledgeReceipt = (id) => {
    if (window.confirm('Are you sure you want to acknowledge this received transfer?')) {
      const updatedEntries = transferEntries.map(entry => 
    ...
    <div className="p-4">
      <div className="bg-white rounded-lg shadow-sm border">
        <div className="bg-teal-600 text-white px-4 py-3 rounded-t-lg">
          <h2 className="font-medium text-lg">Transfer Receive Record</h2>
        </div>
      ...
      {/* Transfer Receive Record Report */}
      {showTable && (
        <div className="bg-white rounded-lg shadow-sm border mt-6">
          <div className="p-4">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-medium">Transfer Receive Record Report</h3>
            ...
            {showSearch && (
              <div className="mb-4 flex gap-2">
                <input
                  type="text"
                  placeholder="Search by voucher no, branch, particulars, category, status, or received by..."
                  value={searchTerm}
            ...
            <div className="mb-4 text-sm text-gray-600">
              Showing {filteredEntries.length} received records for {formData.recordType} transfers from {formData.fromDate} to {formData.toDate}
            </div>
              ...
              <div className="min-w-full">
                ...
                {currentEntries.length > 0 ? (
                  currentEntries.map((entry) => (
                    <div key={entry.id} className="grid grid-cols-13 gap-2 text-xs py-2 border-b hover:bg-gray-50">
                      ...
                      <div className="flex gap-1">
                        ...
                        <button 
                          onClick={() => handleAcknowledgeReceipt(entry.id)}
                  ...
                  <div className="text-center py-8 text-gray-500">
                    {searchTerm ? 'No matching received records found' : 'Sorry, no matching received records found'}
                  </div>
                )}
