...
export default function TransferPendingRecord() {
  ...
  const [transferEntries, setTransferEntries] = useState([
    {
      ...
      particulars: 'Pending Office Supplies Transfer - Stationery Items',
    ...
    },
    {
      ...
      particulars: 'Pending IT Equipment Transfer - Laptops & Accessories',
    ...
    },
    {
      ...
      fromBranch: 'Main Branch',
      particulars: 'Pending Raw Materials Transfer - Steel Sheets',
    ...
    },
    {
      ...
      particulars: 'Pending Document Transfer - Administrative Files',
      category: 'Documents',
    ...
    },
    {
      ...
      particulars: 'Today\'s Pending Safety Equipment Transfer - Helmets & Gloves',
    ...
    },
    {
      ...
      toBranch: 'Sylhet Branch',
      fromBranch: 'Main Branch',
      particulars: 'Today\'s Pending Emergency Supply Transfer - Medical Equipment',
  ...
  const handleGetReport = () => {
    try {
      ...
      setShowTable(true)
      setCurrentPage(1)
      console.log('Generating transfer pending record report for:', formData)
  ...
  const handlePrint = () => {
    const printContent = `
      <html>
        <head>
          <title>Transfer Pending Record Report</title>
          <style>
        ...
        <body>
          <h1>Transfer Pending Record Report</h1>
  ...
  const handleExport = () => {
    ...
    a.href = url
    a.download = 'transfer_pending_record.csv'
  ...
  const handleDeleteEntry = (id) => {
    if (window.confirm('Are you sure you want to delete this pending transfer record?')) {
  ...
  const handleApproveTransfer = (id) => {
    if (window.confirm('Are you sure you want to approve this pending transfer?')) {
    ...
    <div className="p-4">
      <div className="bg-white rounded-lg shadow-sm border">
        <div className="bg-teal-600 text-white px-4 py-3 rounded-t-lg">
          <h2 className="font-medium text-lg">Transfer Pending Record</h2>
        </div>
      ...
      {/* Transfer Pending Record Report */}
      {showTable && (
        <div className="bg-white rounded-lg shadow-sm border mt-6">
          <div className="p-4">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-medium">Transfer Pending Record Report</h3>
            ...
            <div className="mb-4 text-sm text-gray-600">
              Showing {filteredEntries.length} pending records for {formData.recordType} transfers from {formData.fromDate} to {formData.toDate}
            </div>
              ...
              <div className="min-w-full">
                ...
                {currentEntries.length > 0 ? (
                  currentEntries.map((entry) => (
                    <div key={entry.id} className="grid grid-cols-13 gap-2 text-xs py-2 border-b hover:bg-gray-50">
                      ...
                      <div className="col-span-2 flex gap-1">
                        ...
                        <button 
                          onClick={() => handleApproveTransfer(entry.id)}
                  ...
                  <div className="text-center py-8 text-gray-500">
                    {searchTerm ? 'No matching pending records found' : 'Sorry, no matching pending records found'}
                  </div>
                )}
