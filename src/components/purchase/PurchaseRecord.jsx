...
export default function PurchaseRecord() {
  ...
  const [purchaseEntries, setPurchaseEntries] = useState([
    {
      ...
      particulars: 'Office Supplies - Stationery Items',
    ...
    },
    {
      ...
      particulars: 'Computer Hardware - Laptops',
    ...
    },
    {
      ...
      particulars: 'Raw Materials - Steel Sheets',
    ...
    },
    {
      ...
      invoiceNo: 'SRV-2025-001',
      particulars: 'Maintenance Service',
      category: 'Services',
    ...
    },
    {
      ...
      particulars: 'Safety Equipment - Helmets & Gloves',
    ...
    },
    {
      ...
      particulars: 'Today\'s Purchase - Test Items',
  ...
  const handleGetReport = () => {
    try {
      ...
      setShowTable(true)
      setCurrentPage(1)
      console.log('Generating purchase report for:', formData)
  ...
  const handlePrint = () => {
    const printContent = `
      <html>
        <head>
          <title>Purchase Record Report</title>
          <style>
  ...
  const handleExport = () => {
    const csvContent = [
      ['Date', 'Supplier', 'Invoice No', 'Particulars', 'Category', 'Location', 'User', 'Amount', 'Status'],
      ...filteredEntries.map(entry => [
        entry.date,
        entry.supplier,
        entry.invoiceNo,
        ...
        <div className="bg-white rounded-lg shadow-sm border mt-6">
          <div className="p-4">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-medium">Purchase Record Report</h3>
            ...
            {showSearch && (
              <div className="mb-4 flex gap-2">
                <input
                  type="text"
                  placeholder="Search by supplier, invoice no, particulars, category, or status..."
                  value={searchTerm}
            ...
            <div className="mb-4 text-sm text-gray-600">
              Showing {filteredEntries.length} records for {formData.recordType} purchases from {formData.fromDate} to {formData.toDate}
            </div>
                ...
                {currentEntries.length > 0 ? (
                  currentEntries.map((entry) => (
                    <div key={entry.id} className="grid grid-cols-10 gap-2 text-xs py-2 border-b hover:bg-gray-50">
                      ...
                      <div className="font-medium text-teal-600">{entry.invoiceNo}</div>
