...
export default function PurchaseReturnRecord() {
  ...
  // Sample purchase return record data with Indian business context
  const [purchaseReturnRecordData] = useState([
    { 
      id: 1, 
      sl: 1, 
      date: '24/08/2025',
      returnNo: 'PRET-2025-001',
      originalPurchaseNo: 'PUR-2025-001',
      supplierName: 'Tata Steel Limited',
      productService: 'Raw Materials - Steel Sheets',
      returnQuantity: 15,
      unitPrice: 15000.00,
      returnAmount: 225000.00,
      gstAmount: 40500.00,
      finalReturnAmount: 265500.00,
    ...
    { 
      ...
      sl: 2, 
      date: '23/08/2025',
      returnNo: 'PRET-2025-002',
      originalPurchaseNo: 'PUR-2025-002',
    ...
    { 
      ...
      sl: 3, 
      date: '22/08/2025',
      returnNo: 'PRET-2025-003',
      originalPurchaseNo: 'PUR-2025-003',
      supplierName: 'Bharat Electronics Ltd',
      productService: 'Electronic Components',
      returnQuantity: 100,
      unitPrice: 2500.00,
      returnAmount: 250000.00,
      gstAmount: 45000.00,
      finalReturnAmount: 295000.00,
    ...
    { 
      ...
      sl: 4, 
      date: '21/08/2025',
      returnNo: 'PRET-2025-004',
      originalPurchaseNo: 'PUR-2025-004',
    ...
    { 
      ...
      sl: 5, 
      date: '20/08/2025',
      returnNo: 'PRET-2025-005',
      originalPurchaseNo: 'PUR-2025-005',
      ...
      returnStatus: 'Approved',
      processedBy: 'Vikram Patel'
    },
    { 
      id: 6, 
      sl: 6, 
      date: '19/08/2025',
      returnNo: 'PRET-2025-006',
      originalPurchaseNo: 'PUR-2025-006',
      supplierName: 'Mahindra & Mahindra',
      productService: 'Vehicle Fleet',
      returnQuantity: 1,
      unitPrice: 275000.00,
      returnAmount: 275000.00,
      gstAmount: 49500.00,
      finalReturnAmount: 324500.00,
    ...
    { 
      ...
      sl: 7, 
      date: '18/08/2025',
      returnNo: 'PRET-2025-007',
      originalPurchaseNo: 'PUR-2025-007',
      supplierName: 'Asian Paints Ltd',
      productService: 'Industrial Paints & Coatings',
      returnQuantity: 50,
      unitPrice: 3200.00,
      returnAmount: 160000.00,
      gstAmount: 28800.00,
      finalReturnAmount: 188800.00,
    ...
    { 
      ...
      sl: 8, 
      date: '17/08/2025',
      returnNo: 'PRET-2025-008',
      originalPurchaseNo: 'PUR-2025-008',
      supplierName: 'Larsen & Toubro',
      productService: 'Construction Materials',
      returnQuantity: 10,
      unitPrice: 18000.00,
      returnAmount: 180000.00,
      gstAmount: 32400.00,
      finalReturnAmount: 212400.00,
      returnReason: 'Quantity Mismatch',
      returnStatus: 'Pending',
    ...
    { 
      ...
      sl: 9, 
      date: '16/08/2025',
      returnNo: 'PRET-2025-009',
      originalPurchaseNo: 'PUR-2025-009',
      supplierName: 'Reliance Industries',
      productService: 'Petrochemical Products',
      returnQuantity: 30,
      unitPrice: 12500.00,
      returnAmount: 375000.00,
      gstAmount: 67500.00,
      finalReturnAmount: 442500.00,
      returnReason: 'Contaminated Stock',
      returnStatus: 'Approved',
    ...
    { 
      ...
      sl: 10, 
      date: '15/08/2025',
      returnNo: 'PRET-2025-010',
      originalPurchaseNo: 'PUR-2025-010',
      supplierName: 'Wipro Infrastructure',
      productService: 'IT Infrastructure Setup',
      returnQuantity: 1,
      unitPrice: 500000.00,
      returnAmount: 500000.00,
      gstAmount: 90000.00,
      finalReturnAmount: 590000.00,
      returnReason: 'Technical Incompatibility',
      returnStatus: 'Processing',
      processedBy: 'Kavitha Menon'
    }
  ])

  const [filteredData, setFilteredData] = useState(purchaseReturnRecordData)

  // Filter options for purchase return record
  ...
  const handleGetReport = () => {
    console.log('Generating purchase return record with filters:', {
      filterType,
      recordType,
      fromDate,
      toDate
    ...
    let filtered = purchaseReturnRecordData
  ...
  const handleSearch = () => {
    if (searchTerm.trim() === '') {
      setFilteredData(purchaseReturnRecordData)
    } else {
      const filtered = purchaseReturnRecordData.filter(entry =>
        entry.returnNo.toLowerCase().includes(searchTerm.toLowerCase()) ||
        entry.originalPurchaseNo.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  const handlePrint = () => {
    const printContent = `
      <html>
        <head>
          <title>Purchase Return Record</title>
          <style>
            ...
            <tbody>
              ${filteredData.map((entry) => `
                <tr>
                  ...
                  <td>${entry.originalPurchaseNo}</td>
  ...
  const handleExport = () => {
    const csvContent = [
      ['SL', 'Date', 'Return No', 'Original Purchase', 'Supplier Name', 'Product/Service', 'Return Qty', 'Unit Price', 'Return Amount', 'GST Amount', 'Final Amount', 'Return Reason', 'Return Status', 'Processed By'],
      ...filteredData.map((entry) => [
        entry.sl,
        entry.date,
        entry.returnNo,
        entry.originalPurchaseNo,
        entry.supplierName,
    ...
    a.href = url
    a.download = 'purchase_return_record.csv'
    ...
    <div className="p-4">
      <div className="bg-white rounded-lg shadow-sm border">
        <div className="bg-teal-600 text-white px-4 py-3 rounded-t-lg">
          <h2 className="font-medium text-lg">Purchase Return Record</h2>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border mt-6">
        <div className="p-4">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-medium">Purchase Return Record</h3>
          ...
          {showSearch && (
            <div className="mb-4 flex gap-2">
              <input
                type="text"
                placeholder="Search by return no, purchase no, supplier name, product/service, status, reason or processed by..."
                value={searchTerm}
            ...
            <table className="min-w-full">
              <thead>
                <tr className="border-b bg-gray-50">
                  ...
                  <th className="text-left py-2 px-3 text-xs font-semibold text-gray-700">Original Purchase</th>
                  <th className="text-left py-2 px-3 text-xs font-semibold text-gray-700 min-w-[180px]">Supplier Name</th>
                  ...
                  <>
                    {currentEntries.map((entry) => (
                      <tr key={entry.id} className="border-b hover:bg-gray-50">
                        ...
                        <td className="py-2 px-3 text-xs font-medium text-indigo-600">{entry.originalPurchaseNo}</td>
