...
export default function BranchLedger() {
  const [filterType, setFilterType] = useState('Select Branch')
  ...
  // Sample branch ledger data with Indian context
  const [branchLedgerData] = useState([
    { 
      id: 1, 
      sl: 1, 
      date: '21/08/2025',
      particulars: 'Inter-branch Transfer - Mumbai to Delhi', 
      voucherNo: 'BR001',
      debit: 250000.00, 
      credit: 0.00, 
      balance: 250000.00
    ...
    { 
      ...
      sl: 2, 
      date: '20/08/2025',
      particulars: 'Branch Sales Collection - Chennai', 
      voucherNo: 'BR002',
      debit: 0.00, 
      credit: 180000.00, 
      balance: 70000.00
    ...
    { 
      ...
      sl: 3, 
      date: '19/08/2025',
      particulars: 'Branch Expense Reimbursement - Kolkata', 
      voucherNo: 'BR003',
      debit: 45000.00, 
      credit: 0.00, 
      balance: 115000.00
    ...
    { 
      ...
      sl: 4, 
      date: '18/08/2025',
      particulars: 'Stock Transfer to Bangalore Branch', 
      voucherNo: 'BR004',
      debit: 125000.00, 
      credit: 0.00, 
      balance: 240000.00
    ...
    { 
      ...
      sl: 5, 
      date: '17/08/2025',
      particulars: 'Branch Revenue Share - Hyderabad', 
      voucherNo: 'BR005',
      debit: 0.00, 
      credit: 95000.00, 
      balance: 145000.00
    ...
    { 
      ...
      sl: 6, 
      date: '16/08/2025',
      particulars: 'Branch Operating Expenses - Pune', 
      voucherNo: 'BR006',
      debit: 35000.00, 
      credit: 0.00, 
      balance: 110000.00
    ...
    { 
      ...
      sl: 7, 
      date: '15/08/2025',
      particulars: 'Cash Deposit from Jaipur Branch', 
      voucherNo: 'BR007',
      debit: 0.00, 
      credit: 75000.00, 
      balance: 35000.00
    ...
    { 
      ...
      sl: 8, 
      date: '14/08/2025',
      particulars: 'Branch Asset Purchase - Ahmedabad', 
      voucherNo: 'BR008',
      debit: 85000.00, 
      credit: 0.00, 
      balance: 120000.00
  ...
  const [filteredData, setFilteredData] = useState(branchLedgerData)

  // Filter options for branch ledger based on the screenshot
  const filterOptions = [
    'Select Branch',
    'Mumbai Branch',
    'Delhi Branch', 
  ...
  const handleGetReport = () => {
    console.log('Generating branch ledger with filters:', {
      filterType,
      fromDate,
      toDate
    })
    ...
    if (filterType !== 'Select Branch') {
      const branchName = filterType.replace(' Branch', '')
      filtered = filtered.filter(item => 
        item.particulars.toLowerCase().includes(branchName.toLowerCase())
      )
    }
  ...
  const handleSearch = () => {
    if (searchTerm.trim() === '') {
      setFilteredData(branchLedgerData)
    } else {
      const filtered = branchLedgerData.filter(entry =>
    ...
    <div className="p-4">
      <div className="bg-white rounded-lg shadow-sm border">
        <div className="bg-teal-600 text-white px-4 py-3 rounded-t-lg">
          <h2 className="font-medium text-lg">Branch Ledger</h2>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border mt-6">
        <div className="p-4">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-medium">Branch Ledger</h3>
          ...
          {showSearch && (
            <div className="mb-4 flex gap-2">
              <input
                type="text"
                placeholder="Search by branch transaction or voucher number..."
                value={searchTerm}
          ...
          <div className="mt-4 p-4 bg-gray-50 rounded border">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm mt-2">
              ...
              <div>
                <span className="font-medium text-gray-600">Transaction Volume:</span>
                <div className="text-lg font-bold text-orange-600">₹{(totalCredit + totalDebit).toFixed(2)}</div>
              </div>
            </div>
          </div>
        </div>
