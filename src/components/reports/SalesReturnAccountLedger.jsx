...
export default function SalesReturnAccountLedger() {
  ...
  // Sample sales return account ledger data with Indian context
  const [salesReturnAccountLedgerData] = useState([
    { 
      id: 1, 
      sl: 1, 
      date: '21/08/2025',
      particulars: 'Product Return - Defective Electronics Mumbai', 
      voucherNo: 'SR001',
    ...
    { 
      ...
      sl: 2, 
      date: '20/08/2025',
      particulars: 'Customer Return - Wrong Size Clothing Delhi', 
      voucherNo: 'SR002',
      voucherType: 'Customer Return',
      debit: 12500.00, 
      credit: 0.00, 
      balance: 57500.00
    },
    { 
      ...
      sl: 3, 
      date: '19/08/2025',
      particulars: 'Quality Return - Damaged Goods Chennai', 
      voucherNo: 'SR003',
    ...
    { 
      ...
      sl: 4, 
      date: '18/08/2025',
      particulars: 'Warranty Return - Malfunctioned Item Kolkata', 
      voucherNo: 'SR004',
    ...
    { 
      ...
      sl: 5, 
      date: '17/08/2025',
      particulars: 'Bulk Return - Overstock Items Bangalore', 
      voucherNo: 'SR005',
    ...
    { 
      ...
      sl: 6, 
      date: '16/08/2025',
      particulars: 'Exchange Return - Customer Exchange Hyderabad', 
      voucherNo: 'SR006',
      voucherType: 'Exchange Return',
      debit: 23500.00, 
      credit: 0.00, 
      balance: 211500.00
    },
    { 
      ...
      sl: 7, 
      date: '15/08/2025',
      particulars: 'Credit Note Return - Billing Error Pune', 
      voucherNo: 'SR007',
      voucherType: 'Credit Return',
      debit: 18000.00, 
      credit: 0.00, 
      balance: 229500.00
    },
    { 
      ...
      sl: 8, 
      date: '14/08/2025',
      particulars: 'Return Reversal - Incorrect Processing Jaipur', 
      voucherNo: 'RR001',
    ...
    { 
      ...
      sl: 9, 
      date: '13/08/2025',
      particulars: 'Seasonal Return - Outdated Stock Ahmedabad', 
      voucherNo: 'SR008',
      voucherType: 'Seasonal Return',
      debit: 42000.00, 
      credit: 0.00, 
      balance: 256500.00
    },
    { 
      ...
      sl: 10, 
      date: '12/08/2025',
      particulars: 'Vendor Return - Supplier Return Lucknow', 
      voucherNo: 'SR009',
      voucherType: 'Vendor Return',
      debit: 31000.00, 
      credit: 0.00, 
      balance: 287500.00
    }
  ...
  const [filteredData, setFilteredData] = useState(salesReturnAccountLedgerData)

  // Filter options for sales return account ledger
  const filterOptions = [
    'Search Account',
    'Sales Return',
    'Customer Return',
  ...
  const handleGetReport = () => {
    console.log('Generating sales return account ledger with filters:', {
      filterType,
      fromDate,
      toDate
    })
    ...
    let filtered = salesReturnAccountLedgerData
    ...
    if (filterType !== 'Search Account') {
      ...
      } else if (filterType === 'Customer Return') {
        filtered = filtered.filter(item => 
          item.particulars.toLowerCase().includes('customer') ||
          item.voucherType.toLowerCase().includes('customer')
        )
      } else if (filterType === 'Quality Return') {
        filtered = filtered.filter(item => 
          item.particulars.toLowerCase().includes('quality') ||
          item.particulars.toLowerCase().includes('defective') ||
          item.voucherType.toLowerCase().includes('quality')
        )
      } else if (filterType === 'Warranty Return') {
        filtered = filtered.filter(item => 
          item.particulars.toLowerCase().includes('warranty') ||
          item.voucherType.toLowerCase().includes('warranty')
        )
      } else if (filterType === 'Bulk Return') {
        filtered = filtered.filter(item => 
          item.particulars.toLowerCase().includes('bulk') ||
          item.voucherType.toLowerCase().includes('bulk')
        )
      } else if (filterType === 'Exchange Return') {
        filtered = filtered.filter(item => 
          item.particulars.toLowerCase().includes('exchange') ||
          item.voucherType.toLowerCase().includes('exchange')
        )
      } else if (filterType === 'Credit Return') {
        filtered = filtered.filter(item => 
          item.particulars.toLowerCase().includes('credit') ||
          item.voucherType.toLowerCase().includes('credit')
        )
      } else if (filterType === 'Seasonal Return') {
        filtered = filtered.filter(item => 
          item.particulars.toLowerCase().includes('seasonal') ||
          item.voucherType.toLowerCase().includes('seasonal')
        )
      } else if (filterType === 'Vendor Return') {
        filtered = filtered.filter(item => 
          item.particulars.toLowerCase().includes('vendor') ||
          item.particulars.toLowerCase().includes('supplier') ||
          item.voucherType.toLowerCase().includes('vendor')
        )
      }
    }
  ...
  const handleSearch = () => {
    if (searchTerm.trim() === '') {
      setFilteredData(salesReturnAccountLedgerData)
    } else {
      const filtered = salesReturnAccountLedgerData.filter(entry =>
  ...
  const handlePrint = () => {
    const printContent = `
      <html>
        <head>
          <title>Sales Return Account Ledger</title>
          <style>
        ...
        <body>
          <h1>Sales Return Account Ledger</h1>
          ...
          <table>
            ...
            <tbody>
              <tr class="opening-balance">
                ...
                <td class="amount"><strong>₹82,244.00</strong></td>
  ...
  const handleExport = () => {
    ...
    a.href = url
    a.download = 'sales_return_account_ledger.csv'
    ...
    <div className="p-4">
      <div className="bg-white rounded-lg shadow-sm border">
        <div className="bg-teal-600 text-white px-4 py-3 rounded-t-lg">
          <h2 className="font-medium text-lg">Sales Return Account Ledger</h2>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border mt-6">
        <div className="p-4">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-medium">Sales Return Account Ledger</h3>
            ...
            <table className="min-w-full">
              ...
              <tbody>
                ...
                <tr className="border-b bg-green-50">
                  ...
                  <td className="py-2 px-3 text-xs text-right font-bold">₹82,244.00</td>
          ...
          <div className="mt-4 p-4 bg-gray-50 rounded border">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm mt-2">
              ...
              <div>
                ...
                <div className="text-lg font-bold text-orange-600">{netBalance > 0 ? 'Loss' : 'Gain'}</div>
              </div>
            </div>
          </div>
        </div>
